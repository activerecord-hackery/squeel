shared_examples "Relation on ActiveRecord 4.1" do
  ...
  describe '#includes' do
    ...
    it 'includes a keypath' do
      relation = Note.includes{notable(Article).person.children}.references(:notable).where{notable(Article).person.children.name == 'Ernie'}
